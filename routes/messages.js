...
router.post("/", (request, response, next) => {
    ...
    let insert = `INSERT INTO Messages(ChatId, Message, MemberId)
                  VALUES($1, $2, $3) 
                  RETURNING PrimaryKey AS MessageId, ChatId, Message, MemberId AS email, username, TimeStamp`
...
router.get("/:chatId?/:messageId?", (request, response, next) => {
    ...
    let query = `SELECT Messages.PrimaryKey AS messageId, Members.Email, Members.Username, Messages.Message, 
